...
{
public:
    epos4(uint32_t canid_epos, uint32_t canid_self, const struct device *CAN_INTERFACE, struct k_msgq *my_can_msgq1, struct k_msgq *my_can_msgq2, struct zcan_frame *rx_frame);
